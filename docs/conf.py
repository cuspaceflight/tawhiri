...
project = 'Tawhiri'
copyright = '2014, Cambridge University Spaceflight'
...
man_pages = [
    ('index', 'tawhiri', 'Tawhiri Documentation',
     ['Cambridge University Spaceflight'], 1)
]
...
texinfo_documents = [
  ('index', 'Tawhiri', 'Tawhiri Documentation',
   'Cambridge University Spaceflight', 'Tawhiri', 'One line description of project.',
   'Miscellaneous'),
]
