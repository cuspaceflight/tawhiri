...
:cls:`Dataset` contains some utility methods to find/list datasets in a
...
:cls:`numpy.ndarray from this mapping, and :mod:`tawhiri.interpolate` casts
...
class Dataset(object):
    ...
    .. attribute:: array
        ...
        A :cls:`mmap.mmap` object; the entire dataset mapped into memory.

    .. attribute:: ds_time

        The forecast time of this dataset (:cls:`datetime.datetime`).
    ...
    #: The values of the points on each axis: a 5-(named)tuple (hour, pressure
    ...
    def filename(cls, directory, ds_time, suffix=''):
        ...
        :type ds_time: :cls:`datetime.datetime`
